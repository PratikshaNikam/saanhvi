...
function preload(){
  ...
  mangunImg=loadImage("images/mangun.png");
...
function setup(){
 ...
 score=0;
  ...
  bg.addImage("background",sand);
   ...
   mangun=createSprite(player1.x-200,player1.y-100,40,80);
   mangun.addImage("enemy",mangunImg);
   player1.addAnimation("fall",girlfallImg);
   mangun.scale=2;
   console.log(mangun);

   pyramid.debug=true;
   pyramid2.debug=true;
   pyramid2.setCollider("rectangle",0,0,120,120);
...
function draw(){
  ...
  if(gameState===1){
   ...
   player1.collide(pyramid);
   player1.collide(pyramid2);
   player1.collide(pyramid3);
